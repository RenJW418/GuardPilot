...
npm run evidence    # 验证 GuardPilot 的回撤降低、权益改善和审计证据
...
npm run evidence    # verify drawdown reduction, equity improvement and audit evidence
...
- `guardpilot/docs/evidence.md` — data-truthfulness note and evidence pack
