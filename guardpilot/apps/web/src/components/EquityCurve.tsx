...
export function EquityCurve({ trades }: { trades: Trade[] }) {
  ...
  return (
    <div className="card wide">
      <div className="section-title">Guarded Paper Equity Curve</div>
      <p>Shows the paper equity path after GuardPilot decisions. Baseline without-guard comparison is summarized in the impact metrics above.</p>
      {data.length ? (
        ...
        <div className="empty-panel">Run replay to draw the guarded paper-trading equity curve.</div>
      )}
    </div>
  );
}
